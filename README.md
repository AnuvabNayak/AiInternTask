# Object Detection Model using Detectron2 and Mask R-CNN
...
<h2>Features</h2>
1. Object Detection: The model detects multiple objects in an image and draws bounding boxes around them.
2. Instance Segmentation: The model generates a segmentation mask for each detected object along with object detection.
3. Customizable: You can train the model on any custom dataset.
4. Pre-trained Models: Utilize pre-trained models for faster training and better performance.
